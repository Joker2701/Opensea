...
class Metrics:
    ...
    #: ATM IV на найближчому лістованому тенорі — суто довідкове поле.
    #: Не впливає на жоден розрахунок і не гейтить видачу: гайд користувача
    #: радить заходити при "спокійному" вол-режимі (нижче IV зараз -> більше
    #: шансів на майбутній імпульсний рух), але без прив'язки до конкретного
    #: порогу — той поріг у гайді специфічний до індикатора автора, який ми
    #: не можемо відтворити. Ми просто показуємо число, рішення за людиною.
    atm_iv_near: float = 0.0
    atm_iv_term_days: float = 0.0
